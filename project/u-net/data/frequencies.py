...
def compute_class_weights(data_folder, split="train"):
    ...
    mask_dir = os.path.join(data_folder, "SegmentationClass")
    txt_path = os.path.join(data_folder, "ImageSets", "Segmentation", f"{split}.txt")
...
if __name__ == "__main__":
    ...
    weights = compute_class_weights(data_folder)
